...
class AnimationImporter(Operator, ImportHelper):
    ...
    def insert_key_frames_for_animation(self, animation: Animation0xC80x17):
        for currentAnimationFrameIndex in range(len(animation.AnimationFrames)):
            ...
            offset_bone.location[0] = currentAnimationFrame.properties['Offset'].z * 0.001
            offset_bone.location[1] = currentAnimationFrame.properties['JumpStrength'].y * 0.001 - 1
            ...
            upper_body_bone.rotation_euler.z = currentAnimationFrame.properties['UpperBody'].z - 1.57
            ...
            lower_body_bone.rotation_euler.z = currentAnimationFrame.properties['LowerBody'].z + 1.57
            ...
            head_bone.rotation_euler.x = currentAnimationFrame.properties['Head'].x - 1.57
            head_bone.rotation_euler.y = currentAnimationFrame.properties['Head'].z - 1.57
            head_bone.rotation_euler.z = currentAnimationFrame.properties['Head'].y * -1

            # right_inner_shoulder.rotation_euler.x = (currentAnimationFrame.properties['RightInnerShoulder'].z + 3.14) * -1
            # right_inner_shoulder.rotation_euler.y = (currentAnimationFrame.properties['RightInnerShoulder'].x) * -1 + 1.57
            # right_inner_shoulder.rotation_euler.z = (currentAnimationFrame.properties['RightInnerShoulder'].y - 3.14) * -1

            right_outer_shoulder.rotation_euler.x = currentAnimationFrame.properties['RightOuterShoulder'].x
            right_outer_shoulder.rotation_euler.y = currentAnimationFrame.properties['RightOuterShoulder'].y
            right_outer_shoulder.rotation_euler.z = currentAnimationFrame.properties['RightOuterShoulder'].z
            ...
            right_hand.rotation_euler.x = currentAnimationFrame.properties['RightHand'].x - 1.57
            ...
            left_outer_shoulder.rotation_euler.x = currentAnimationFrame.properties['LeftOuterShoulder'].x
            ...
            left_hand.rotation_euler.x = (currentAnimationFrame.properties['LeftHand'].x - 1.57) * -1
            left_hand.rotation_euler.y = currentAnimationFrame.properties['LeftHand'].z * -1
            ...
            left_hip.rotation_euler.x = currentAnimationFrame.properties['RightHip'].x
            left_hip.rotation_euler.y = currentAnimationFrame.properties['RightHip'].y
            left_hip.rotation_euler.z = currentAnimationFrame.properties['RightHip'].z

            left_knee.rotation_euler.z = currentAnimationFrame.properties['RightKnee'].z
